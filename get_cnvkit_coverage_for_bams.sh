...
while IFS='' read -r line || [[ -n "$line" ]]; do
    ...
    /Users/shung/Downloads/cnvkit-0.9.1/cnvkit.py coverage bam/$line.bam baits.target.bed -o $line.targetcoverage.cnn
    /Users/shung/Downloads/cnvkit-0.9.1/cnvkit.py coverage bam/$line.bam baits.antitarget.bed -o $line.antitargetcoverage.cnn
done < "$1"
